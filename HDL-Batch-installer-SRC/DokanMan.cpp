...
DokanMan::DokanMan(wxWindow* parent, wxArrayString PARTITIONS_, wxString HDD, wxWindowID id): PARTITION_LIST(PARTITIONS_), CURR_HDD(HDD)
{
    ...
    Create(parent, wxID_ANY, _("Dokan Manager"), wxDefaultPosition, wxDefaultSize, wxSTAY_ON_TOP|wxCAPTION|wxSYSTEM_MENU|wxRESIZE_BORDER|wxCLOSE_BOX|wxMINIMIZE_BOX|wxCLIP_CHILDREN, _T("wxID_ANY"));
    ...
    StaticBoxSizer1->Add(partyselector, 1, wxALL|wxEXPAND, 5);
    ...
    StaticBoxSizer2->Add(currhdd, 1, wxALL|wxEXPAND, 5);
    ...
    StaticBoxSizer3->Add(Drive_selector, 1, wxALL|wxEXPAND, 5);
    ...
    BoxSizer5->Add(Gauge1, 1, wxTOP|wxLEFT|wxRIGHT|wxALIGN_TOP, 5);
    ...
    BoxSizer4->Add(BoxSizer3, 1, wxALL|wxEXPAND, 5);
    FlexGridSizer1->Add(BoxSizer4, 1, wxALL|wxEXPAND, 5);
