...
const long mkpartdlg::ID_STATICLINE1 = wxNewId();
...
mkpartdlg::mkpartdlg(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	MB = new wxStaticText(this, ID_STATICTEXT1, _("128Mb"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT1"));
	FlexGridSizer3->Add(MB, 1, wxALL|wxEXPAND, 5);
	StaticLine1 = new wxStaticLine(this, ID_STATICLINE1, wxDefaultPosition, wxSize(10,-1), wxLI_HORIZONTAL, _T("ID_STATICLINE1"));
	FlexGridSizer3->Add(StaticLine1, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	GB = new wxStaticText(this, ID_STATICTEXT2, _("0.12Gb"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT2"));
	FlexGridSizer3->Add(GB, 1, wxALL|wxEXPAND, 5);
