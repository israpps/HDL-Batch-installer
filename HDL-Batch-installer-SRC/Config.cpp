...
Config::Config(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
    ...
    Create(parent, wxID_ANY, _("Settings"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE|wxRESIZE_BORDER, _T("wxID_ANY"));
    ...
    StaticBoxSizer3->Add(language_choice, 1, wxALL|wxALIGN_TOP, 5);
    ...
    GridSizer1->Add(miniopl_warning, 1, wxALL|wxEXPAND, 5);
    ...
    GridSizer1->Add(osd_hide_settings, 1, wxALL|wxEXPAND, 5);
    ...
    FlexGridSizer4->Add(StaticBoxSizer5, 1, wxALL|wxEXPAND, 5);
    ...
    FlexGridSizer4->Add(StaticBoxSizer6, 1, wxALL|wxEXPAND, 5);
    StaticBoxSizer1->Add(FlexGridSizer4, 1, wxALL|wxEXPAND, 5);
    ...
    StaticBoxSizer7->Add(MountPoint, 1, wxALL|wxALIGN_TOP, 5);
    ...
    StaticBoxSizer8->Add(OPLPART, 1, wxALL|wxALIGN_TOP, 5);
    FlexGridSizer3->Add(StaticBoxSizer8, 1, wxALL|wxEXPAND, 5);
